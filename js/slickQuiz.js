 ...
 */
 ...
 /*
    Download XDK
    If wrong --> keep answering until right
        keep track of how often answer correctly on first try
    ...
    $.slickQuiz = function(element, options) {
        ...
        plugin.method = {
            ...
            checkAnswer: function(checkButton) {
                ...
                var enterAnAnswerMsg = 'You must select at least one answer.';                
                var enterCorrectAnswerMsg = 'You must select at the correct answer to proceed.';

                if (plugin.config.preventUnanswered && selectedAnswers.length === 0) {
                    alert(enterAnAnswerMsg);
                    return false;
                }
                ...
                {
                   alert(enterCorrectAnswerMsg);
                   
                   //   Set "first try flag" to no.
                   isFirstTry = false;
                    return false; 
                }
            ...
            nextQuestion: function(nextButton) {
                    ...
                    if (nextQuestion.length) {
                        currentQuestion.fadeOut(300, function(){
                            //   Set "first try flag" to yes.
                            isFirstTry = true
                            console.log("Resetting first try flag.");
            ...
            completeQuiz: function() {
                ...
                //can change this to reflect % better!

                $(_quizScore + ' span').html(  ( (score/questionCount)*100 ) + '%'    );
